...
<html lang="en-US"><head>
        ...
        <meta name="mswebdialog-title" content="Establishing Connection">
...
<style>.illustrationClass {background-image:url('https://LINKTOCOMPANYBACKGROUND');}
* {
	margin:0px;
	padding:0px;
}
...
@media only screen and (max-width:280px)
{
    ...
    <div id="fullPage">
        ...
        <div id="contentWrapper" class="float">
            <div id="content">
                <div id="header">
                    <img class="logoImage" src="https://LINKTOCOMPANYLOGO" alt="COMPANYNAME">
                </div>
                <div id="workArea">
    ...
    <div id="errorArea"> 
        ...
        <div id="errorMessage" class="groupMargin">
            This resource is currently unavailable. Please try again later or contact your administrator for more information. 
        </div>
        ...
        <ul id="errorDetails" class="indent block smallText" style="display:none">
            <li id="activityID">Activity ID: 00000000-0000-0000-a20b-008000000039</li>         
                        
            <li>Cookie: enabled</li><li>User agent string: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.85 Safari/537.36</li></ul>
